    ...
    <>
       ...
       <Head>
        {product?.map((pro: product) => (
          <title key="title">{pro.title} - فروشگاه مبلمان</title>
        ))}
        <meta
          name="description"
          content="مشاهده جزئیات و مشخصات محصولات فروشگاه مبلمان. افزودن به سبد خرید و خرید آنلاین با قیمت مناسب."
        />
        <meta name="keywords" content="مبلمان، جزئیات محصول، فروشگاه آنلاین، افزودن به سبد خرید" />
        <meta name="author" content="نام نویسنده یا نام شرکت" />

        {/* Open Graph Meta Tags */}
        {product?.map((pro: product) => (
          <meta key="og-title" property="og:title" content={`${pro.title} - فروشگاه مبلمان`} />
        ))}
        <meta
          key="og-description"
        ...
        <meta key="og-url" property="og:url" content="آدرس صفحه فعلی" />
        ...
        {product?.map((pro: product) => (
          <meta
            key="twitter-title"
            name="twitter:title"
            content={`${pro.title} - فروشگاه مبلمان`}
          />
        ))}
        <meta
          ...
          content="مشاهده جزئیات و مشخصات محصولات فروشگاه مبلمان. افزودن به سبد خرید و خرید آنلاین با قیمت مناسب."
        />
        <meta key="twitter-image" name="twitter:image" content={activeImage} />
      </Head>
                ...
                <div className="sticky top-0  overflow-hidden ">
                  <div className="relative -z-50 mb-6 lg:mb-10 lg:h-2/4 ">
                    <img
                      src={activeImage}
                      alt=""
                      className="-z-50 object-cover w-full lg:h-full "
                    />
                  </div>
                      ...
                      image.map((imag) => (
                        <div className="w-1/2 p-2 sm:w-1/4">
                          <button
                            ...
                            onClick={() => setActiveImage(imag.url)}
                          >
                            <img
                              src={imag.url}
                              alt=""
              ...
              <div className="w-full px-4 md:w-1/2 ">
                <div className="lg:pl-20">
                  <div className="mb-8 ">
                    ...
                    <p className="max-w-md text-gray-700 ">{pro.description}</p>
                  </div>

                  <div className="flex flex-col mb-8 ">
                    {pro.properties.map((pro: properties) => (
                      <>
                        <h2 className="w-fit pb-1 mb-4 text-xl font-semibold border-b border-blue-300 ">
                          {pro.name}
                        </h2>
                        <div>
                          <div>
